...
// Codrithm brand colors: #87FFBC (green) and #0066FF (blue)
const BRAND_COLORS = [
  { r: 0x87 / 255, g: 0xFF / 255, b: 0xBC / 255 }, // #87FFBC green
  { r: 0x00 / 255, g: 0x66 / 255, b: 0xFF / 255 }, // #0066FF blue
];
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // generateColor cycles through Codrithm brand colors (#87FFBC green, #0066FF blue)
    // with a brightness boost for visibility against dark backgrounds
    function generateColor() {
      ...
      // Alternate between brand green and brand blue
      const base = BRAND_COLORS[brandColorIndex % BRAND_COLORS.length];
      brandColorIndex++;
